<?php
// Имя, профессия, город/страна, e-mail, телефон. Задайте начальные значения переменных
          ...
          <div class="w3-container">
            ...
            <?php for ($i = 0; $i < count($skills); $i++): ?>
                ...
                <div class="w3-light-grey w3-round-xlarge w3-small">
                    <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skills[$i]['percent'].'%'; ?>"><?=$skills[$i]['percent']; ?>%</div>
                </div>
            <?php endfor; ?>
